...
import static io.wdedei.utrustning.Utrustning.*;

public class rarrowe extends PersistentProjectileEntity {
    private static final TrackedData<Integer> COLOR;
    private Potion potion;
    private final Set<StatusEffectInstance> effects;
    private boolean colorSet;

    public rarrowe(EntityType<rarrowe> entityType, World world) {
        super(entityType, world);
        this.potion = Potions.EMPTY;
        this.effects = Sets.newHashSet();
    }

    public rarrowe(World world, double x, double y, double z) {
        super(EntityType.ARROW, x, y, z, world);
        this.potion = Potions.EMPTY;
        this.effects = Sets.newHashSet();
    }

    public rarrowe(World world, LivingEntity owner) {
    ...
    protected ItemStack asItemStack() {
        if (this.effects.isEmpty() && this.potion == Potions.EMPTY) {
            return new ItemStack(RARROW);
        } else {
            ItemStack itemStack = new ItemStack(RARROW);
    ...
    static {
        COLOR = DataTracker.registerData(rarrowe.class, TrackedDataHandlerRegistry.INTEGER);
    }
}
