...
import io.wdedei.utrustning.linkage.UtrustningLinkage;
import net.fabricmc.api.ModInitializer;
import io.wdedei.utrustning.item.rstone;
import io.wdedei.utrustning.items.r;
...
public class Utrustning implements ModInitializer {
	private static final Enchantment FROST = Registry.register(
			Registry.ENCHANTMENT,
			new Identifier("p", "frost"),
			new hE()
	);
	public static final StructurePieceType MY_PIECE = MyPiece::new;	// teddyxlandlee finally found there's no bug.
	...
	public void onInitialize() {
		...
		FabricLoader.getInstance().getEntrypoints("utrustning", UtrustningLinkage.class).forEach(UtrustningLinkage::init);
