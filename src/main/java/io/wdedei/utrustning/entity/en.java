package io.wdedei.utrustning.entity;
...
public class en extends Entity {
    private static final TrackedData<Integer> FUSE;
    @Nullable
    private LivingEntity causingEntity;
    private int fuseTimer;

    public en(EntityType<TntEntity> entityType, World world) {
        super(entityType, world);
        this.fuseTimer = 10;
        this.inanimate = true;
    }

    public en(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(TNT,world);
    ...
    private void explode() {
        float f = 4.0F;
        this.world.createExplosion(this, this.getX(), this.getBodyY(0), this.getZ(), 10.0F, Explosion.DestructionType.BREAK);
    }
    ...
    static {
        FUSE = DataTracker.registerData(en.class, TrackedDataHandlerRegistry.INTEGER);
    }
}
