...
public class bow1 extends BowItem {
    public bow1(Settings settings) {
        super(settings.maxDamage(768));
    }
            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if ((double)f >= 0.2D) {
                    ...
                    if (!world.isClient) {
                        ...
                        persistentProjectileEntity.setProperties(playerEntity, playerEntity.pitch, playerEntity.yaw, 1.0F, f * 4.0F, 0.0F);
                        if (f == 2.0F) {
