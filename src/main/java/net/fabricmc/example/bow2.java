...
public class bow2 extends BowItem {
    public bow2(Settings settings) {
        super(settings.maxDamage(1536));
    }
            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if ((double)f >= 0.3D) {
                    ...
                    if (!world.isClient) {
                        ...
                        persistentProjectileEntity.setProperties(playerEntity, playerEntity.pitch, playerEntity.yaw, 2.0F, f * 6.0F, 0.0F);
                        if (f == 3.0F) {
