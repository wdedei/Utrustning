...
import net.fabricmc.example.entity.en;
import net.fabricmc.example.entity.en1;
...
public class tnt2 extends TntBlock {
    public static final BooleanProperty UNSTABLE;

    public tnt2(Settings settings) {
        super(settings);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        if (!world.isClient) {
            en1 tntEntity = new en1(world, (double)pos.getX() + 0.5D, (double)pos.getY(), (double)pos.getZ() + 0.5D, explosion.getCausingEntity());
    ...
    private static void primeTnt(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        if (!world.isClient) {
            en1 tntEntity = new en1(world, (double)pos.getX() + 0.5D, (double)pos.getY(), (double)pos.getZ() + 0.5D, igniter);
            world.spawnEntity(tntEntity);
